...
public class DiscreteModeChoiceConfigGroup extends ReflectiveConfigGroup {
	...
	private ModelType modelType = ModelType.Tour;
	private FallbackBehaviour fallbackBehaviour = FallbackBehaviour.EXCEPTION;
	...
	public static enum WriteUtilities{NONE, ALL, LAST};
	...
	public void setFallbackBehaviour(FallbackBehaviour fallbackBehaviour) {
	...
	public FallbackBehaviour getFallbackBehaviour() {
	...
	/**
	 * @return -- {@value #WRITE_UTILITIES_CMT}
	 */
	@StringGetter(WRITE_UTILITIES)
	public WriteUtilities getWriteUtilities() {
		return this.writeUtilities;
	}
