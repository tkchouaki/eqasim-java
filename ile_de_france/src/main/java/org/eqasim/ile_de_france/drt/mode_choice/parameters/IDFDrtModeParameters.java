...
public class IDFDrtModeParameters extends IDFModeParameters {
	...
	public static IDFDrtModeParameters buildDefault() {
		// This is a copy & paste

		IDFDrtModeParameters parameters = new IDFDrtModeParameters();
